...
PAGE_INDICES = [79,80]  # TODO: fill in (PDF page number - 1 for each page)
OUTPUT_PATH = "/mnt/c/Users/ribhu/csep/Debt Service Coverage Ratio (Cash Adjusted)/dscr_cash_adjusted_2022-23.csv"
...
COLUMNS = [
    ...
    "Total_Interest_Cost",
    "Opening_Current_Maturities_LT_Borrowings_and_Interest_Accrued_and_Due",
    "DSCR_Cash_Adjusted",
]
...
# ================================================================
# CHANGE ZONE 3 — VERSION B (has decimals — ratio column)
# ================================================================
...
print(df.head(16))  # 4 cols * 4 rows
