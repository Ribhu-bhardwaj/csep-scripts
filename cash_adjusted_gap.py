...
PAGE_INDICES = [55, 56] # Update to match the exact page index of this specific table
OUTPUT_PATH = "/mnt/c/Users/ribhu/csep/Cash Adjusted Gap/cash_adjusted_gap_2022-23.csv"
...
# ================================================================
COLUMNS = [
    "Gross_Input_Energy_(MU)",
    "Total_Revenue_(excluding_Regulatory_Income_and_Revenue_Grant_under_UDAY_for_loan_takeover)_(Rs_crore)",
    "Unrealised_Revenue_from_Sale_of_Power_(Rs_crore)",
    "Unrealised_Tariff_and_Non-Tariff_Subsidies_(Rs_crore)",
    "Cash_Adjusted_Revenue_(Rs_crore)",
    "Cash_Adjusted_ARR_(Rs/kWh)",
    "Cash_Adjusted_Gap_(ACS-Cash_Adjusted_ARR)_(Rs/kWh)"
]

# Set specific units per column position
...
def parse(lines):
    ...
    skip_patterns = [
        'Cash Adjusted Gap',
        'Section 1', 'Annexure', '2024-25',
        'Gross Input', 'Energy', '(MU)',
        'Total Revenue', '(excluding', 'Regulatory', 'Income and', 'Revenue Grant', 'under UDAY for', 'loan takeover)', '(Rs crore)',
        'Unrealised', 'Revenue from', 'Sale of Power',
        'and Non-Tariff', 'Subsidies',
        'Cash Adjusted', 'Revenue', 'ARR', 'Gap (ACS-Cash', 'Adjusted ARR)', '(Rs/kWh)',
