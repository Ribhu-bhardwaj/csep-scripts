...
PAGE_INDICES = [39, 40] # Update to match the exact page index of this table
OUTPUT_PATH = "/mnt/c/Users/ribhu/csep/Cost Structure on Energy Sold basis/cost_structure_on_energy_sold_basis_2022-23.csv"

YEAR_OF_PUBLISHING = "Feb 2026"
YEAR_OF_DATA = "2022-23"
ANNEXURE = "1.2 (b)" # Adjusted to match standard report numbering sequencing
...
# All columns are in Rs./kWh for this specific table
UNITS = ["Rs/kWh"] * 6
...
# Explicit fix for potential state alignment leak on Puducherry / Puducherry PD
for rec in records:
...
print(f"Count of 0.0 values: {(df['number'] == 0.0).sum()}")
