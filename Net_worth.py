...
PAGE_INDICES = [73,74]  # TODO: fill in (PDF page number - 1 for each page)
OUTPUT_PATH = "/mnt/c/Users/ribhu/csep/Net Worth, Consumer Contribution & Total Borrowings_2022-23.csv"
...
COLUMNS = [
    ...
    "Total_Borrowings_including_State_Govt_Borrowings",
]
...
print(df.head(24))  # 8 cols * 3 rows
